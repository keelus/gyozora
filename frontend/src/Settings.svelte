		...
		<div class="bottom">
			...
			<div class="content">
				{#if activeCategory == SettingCategories.APPEARANCE}
					...
					<button on:click={() => SetSetting("theme", "dark")}>Dark</button>
					<button on:click={() => SetSetting("theme", "light")}>Light</button>
					<h3>Translucency</h3>
					...
					<button on:click={() => SetSetting("colorTheme", "default")}>Default</button>
